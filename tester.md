...
1. Делаем форк (fork) интересующего проекта стороннего аккаунта
...
Нужно удалить чистовик

**Основания**

1. Зачем он нужен, эта ветка лучше
2. Он лишний
3. Он слишком идевльный
Не ужно удалять чистовик, пусть живет

**Причины**

1. Читстовик всегда нужен;
2. В нем еще сдавать задачи;
3. В нем все должно быть без ошибок.
...
Проверка выгрузки на ГХ
Проверка выгрузки через Git Pull
Затупил, не ту команду использовал. Попробуем теперь применить  GitPull

А теперь зальем обюратно. 